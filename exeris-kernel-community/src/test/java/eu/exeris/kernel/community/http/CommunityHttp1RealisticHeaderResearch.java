...
/**
 * The fixtures behind RFC-2026-09-01: what a real request costs on the read path.
 *
 ...
 *
 * <p>Reverting {@code CanonicalHeaderNames.resolve} to return {@code null} and re-running is how the
 * name half of the per-request cost is measured, which is how the table's 21–25% was established.
 *
