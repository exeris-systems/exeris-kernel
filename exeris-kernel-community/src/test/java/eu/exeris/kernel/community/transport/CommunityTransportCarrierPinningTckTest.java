...
@DisplayName("Community: Transport Carrier Pinning TCK")
class CommunityTransportCarrierPinningTckTest extends TransportCarrierPinningTck {
    ...
    protected TransportEngine createEngine() {
        ...
        pair = CommunityTransportTestHarness.openLoopbackPair(allocator, true);
