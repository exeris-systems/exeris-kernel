...
@DisplayName("Community: HttpHandler TCK")
class CommunityHttpHandlerTckTest extends AbstractHttpHandlerTck {
    ...
    private static final class RecordingStream implements TransportStream {
        ...
        public TransportConnection connection() {
            throw new UnsupportedOperationException("Not required by handler TCK");
        }
