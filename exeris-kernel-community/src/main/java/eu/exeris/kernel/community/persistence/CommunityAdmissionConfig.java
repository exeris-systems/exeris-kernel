...
public record CommunityAdmissionConfig(
    ...
    @SuppressWarnings("PMD.MutableStaticState") // intentional @Dynamic hot-reload pointer (atomic volatile swap)
    ...
    public CommunityAdmissionConfig {
        ...
        if (fairnessQueueDepthThreshold < 0L) {
        ...
        if (earlyGuardBandHeadroomCap < 1) {
