...
final class CommunityWebSocketUpgradeRequest {
    ...
    /* default */ record Parsed(HttpRequest request, boolean malformed) {
        /* default */ static final Parsed INCOMPLETE = new Parsed(null, false);
        /* default */ static final Parsed MALFORMED = new Parsed(null, true);
    }

    /* default */ static Parsed read(TransportStream stream) {
