...
Why it matters:
- directly impacts CPU efficiency, latency, and runtime geometry,
- informs PAQS execution seam design,
- may produce external evidence relevant to Loom evolution.

Expected outcome:
- scheduler seam,
- benchmark findings,
- possible ADR or transport-level feature promotion.

### 2. OpenSSL 4.0 Migration Envelope for Native Crypto
