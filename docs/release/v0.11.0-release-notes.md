...
**2 282 classes of ours across the eight published modules, class-file major 69, zero
preview-stamped.** The gate scans 15 181 classes in total, because it checks the dependencies the
