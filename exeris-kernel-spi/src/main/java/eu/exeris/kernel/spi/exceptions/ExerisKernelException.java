...
public abstract class ExerisKernelException extends RuntimeException {
     ...
     * Immutable; used by log scrapers and Glass-Box binary serializers.
     */
    ...
    /**
     * Raw domain arguments – the "Glass Box payload".
     *
     ...
     * <p>Correlate this UUID with APM / Glass-Box logs to reconstruct
     ...
     * <p>Can be used by the Glass-Box serializer to order crash events on the timeline.
     *
