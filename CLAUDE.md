...
- **Coordinates:** groupId `eu.exeris.preview` **on this branch** (`eu.exeris` on the distributed line), packages `eu.exeris.kernel.<module>.<subsystem>`, GitHub `exeris-systems/exeris-kernel`. Version here: 0.11.1; on `main`: 0.11.0; active development: v0.12.
