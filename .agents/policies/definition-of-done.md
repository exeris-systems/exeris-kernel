...
3. **`ExerisArchitectureTest` green.** Run it yourself; do not assume CI covers it — it has
   historically been `@ArchIgnore`'d. Note what that suite can and cannot see
