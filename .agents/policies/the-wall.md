...
declares `exeris-kernel-core`, and Community main sources carry 93 `eu.exeris.kernel.core.*` import
statements across 66 distinct types on this branch. The boundary that is real, and the one to
