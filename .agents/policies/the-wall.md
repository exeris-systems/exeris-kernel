...
declares `exeris-kernel-core`, and Community main sources carry 111 `eu.exeris.kernel.core.*` import
statements across 79 distinct types on this branch. The boundary that is real, and the one to
