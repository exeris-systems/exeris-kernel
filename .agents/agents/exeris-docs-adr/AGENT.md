...
model: inherit
skills: [exeris-docs-adr-check, exeris-doc-impact-triage, exeris-adr-register]
policies: [operating-standards, branch-and-release, bundle:agent-safety-and-autonomy, bundle:error-handling-and-fallback]
references: [build-and-ci]
handoffs:
  - {agent: exeris-architect, when: "the drift is a decision nobody has made, not a page nobody has updated", blocking: true}
