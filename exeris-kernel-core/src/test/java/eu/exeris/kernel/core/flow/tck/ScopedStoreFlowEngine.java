...
/**
 * Test wrapper that injects a {@link FlowSnapshotStore} via {@link KernelProviders#FLOW_SNAPSHOT_STORE}
 * scoped value during {@link #start()}, enabling persistence contract testing.
 *
 * @since 0.5.0
 */
